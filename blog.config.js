...
const BLOG = {
  ...
  THEME: process.env.NEXT_PUBLIC_THEME || 'ukasawa', // 当前主题，在themes文件夹下可找到所有支持的主题；主题名称就是文件夹名，例如 example,fukasawa,gitbook,heo,hexo,landing,matery,medium,next,nobelium,plog,simple
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'WINGSZD', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '话剧🎭单口🎤电影🎞️阅读📖播客🎧', // 作者简介
